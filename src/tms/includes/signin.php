...
<div class="modal fade" id="myModal4" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	...
	<input type="password" name="password" id="password" placeholder="Mật khẩu" value="" required="">	
								...
								<p>Bằng cách đăng nhập, bạn đồng ý với chúng tôi <a href="page.php?type=terms">Điều khoản và Điều kiện</a> & <a href="page.php?type=privacy">Chính sách bảo mật</a></p>
							</div>
						</div>
					</div>
				</div>
