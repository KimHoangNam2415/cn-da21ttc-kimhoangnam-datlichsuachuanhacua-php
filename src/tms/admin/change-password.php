...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="dashboard.php">Trang điều khiển</a><i class="fa fa-angle-right"></i>Thay đổi mật khẩu</li>
            </ol>
		<!--grid-->
 	<div class="grid-form">
	...
	<div class="form-group">
							...
							<div class="col-md-8">
								<div class="input-group">
									...
									<input type="password" class="form-control1" name="newpassword" id="newpassword" placeholder="NMật khẩu mới" required="">
								</div>
							</div>
						</div>
