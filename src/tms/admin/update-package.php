...
<html>
<head>
<title>Xem chi tiết dịch vụ</title>
...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html" style="color: #3F84B1">Trang điêu điều khiển</a><i class="fa fa-angle-right"></i>Cập nhật gói </li>
            </ol>
		<!--grid-->
 	<div class="grid-form">
...
<!---->
  <div class="grid-form1">
  	       <h3 style="color: #3F84B1">Gói cập nhật</h3>
...
<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Giá Trị VND</label>
									<div class="col-sm-8">
...
<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Chi Tiết Gói Dịch Vụ</label>
									<div class="col-sm-8">
...
<div class="col-sm-8">
<img src="pacakgeimages/<?php echo htmlentities($result->PackageImage);?>" width="200">&nbsp;&nbsp;&nbsp;<a href="change-image.php?imgid=<?php echo htmlentities($result->PackageId);?>" style="color: #3F84B1">Thay đổi hình ảnh</a>
</div>
</div>
...
<?php echo htmlentities($result->UpdationDate);?>
			...
			<div class="col-sm-8 col-sm-offset-2">
				<button type="submit" name="submit" class="btn-primary btn" style="background-color: #3F84B1">Cập nhật</button>
			</div>
		</div>
