	...
	<div class="grid-form1">
			<h3 style="color: #3F84B1">Cập nhật dữ liệu trang</h3>
	...
	?>
				...
				<div class="col-sm-8 col-sm-offset-2">
					<button type="submit" name="submit" value="Update" id="submit" class="btn-primary btn" style="background-color: #3F84B1">Cập nhật</button>
